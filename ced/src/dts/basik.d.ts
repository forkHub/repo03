...
declare namespace Basik {
    class ImgImpl {
        ...
        static MuatAnimasi(url: string, pf: number, lf: number, tipeDrag?: number): ImageObj;
        static GambarSemua(): void;
        static Bound(s: ImageObj): Kotak;
        static muatAnimasiAsyncKanvas(url: string, pf: number, lf: number, canvas: HTMLCanvasElement, tipeDrag: number): ImageObj;
        static muatAsyncBerbagiKanvas(url: string, canvas: HTMLCanvasElement, tipeDrag: number, onload: () => void): ImageObj;
        private static register;
        static Muat(url: string, tipeDrag?: number, onload?: () => void): ImageObj;
...
declare namespace Basik {
    class Image {
        ...
        static LoadAnim(url: string, fw: number, fh: number, dragType?: number): ImageObj;
        static Load(url: string, dragType?: number): ImageObj;
